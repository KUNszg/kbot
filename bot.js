						...
						if (query.length === 0) {
							...
							if (cookieStatus.prestige === 1) {
								if (cookieApi.seconds_left < 3580) {
									...
									const now = new Date();
									kb.whisper(user['username'], user['username'] + ', I will remind in channel ' + channel + '  to eat the cookie in 1h :)');
								...
								if (cookieApi.seconds_left < 1780) {
									...
									const now = new Date();
									kb.whisper(user['username'], user['username'] + ', I will remind you in channel ' + channel + ' to eat the cookie in 30m :)');
									await doQuery('UPDATE cookie_reminders SET channel="' + channel.replace('#', '') + '", fires="' + 
								...
								if (cookieApi.seconds_left < 1180) {
									...
									const now = new Date();
									kb.whisper(user['username'], user['username'] + ', I will remind you in channel ' + channel + ' to eat the cookie in 20m :)');
									await doQuery('UPDATE cookie_reminders SET channel="' + channel.replace('#', '') + '", fires="' + 
								...
								if (cookieApi.cookieApi < 7180) {
									...
									const now = new Date();
									kb.whisper(user['username'], user['username'] + ', I will remind you in channel ' + channel + ' to eat the cookie in 2h :)');
									await doQuery('UPDATE cookie_reminders SET channel="' + channel.replace('#', '') + '", fires="' + 
