...
exports.banphrasePass = (output, channel) => new Promise((resolve, reject) => {
	...
	} else if ((channelParsed === "nymn" || channelParsed === "vadikus007") || channelParsed === "pajlada") {
		// other channels
		const banphrasePass = (
...
// fromat time for ping command
// todo: create an universal function for stuff like this or use time.js module
...
// format time for uptime command
// todo: create an universal function for stuff like this or use time.js module
...
// format time for github command
// todo: create an universal function for stuff like this or use time.js module
