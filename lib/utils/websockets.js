...
_cache.type.usersTotal = (await utils.query("SELECT COUNT(userId) count FROM user_list"))[0].count;
_cache.type.commandExecs = (await utils.query("SELECT COUNT(ID) as count FROM executions"))[0].count;
