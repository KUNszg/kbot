...
discord.on("ready", () => {
    setTimeout(async() => {
        ...
        const channel2 = discord.channels.cache.find(channel => channel.id === "964605445811617953");

        const channel3 = discord.channels.cache.find(channel => channel.id === "973733377435918366");
