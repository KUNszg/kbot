            ...
            */
            ...
            if (msg[0] === "yoink") {
                ...
                try {
                    ...
                    shell.execSync(`curl -X "PUT" "https://api.spotify.com/v1/me/player/play" --data "{\\"uris\\":[\\"${yoinkedSong.item.uri}\\"],\\"position_ms\\":${position}}" -H "Accept: application/json" -H "Content-Type: application/json" -H "Authorization: Bearer ${tkn[0].access_token}"`)
