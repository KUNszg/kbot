...
module.exports = {
    ...
    invocation: async (channel, user, message, args) => {
        try {
            ...
            if (!msg[0]) {
                const song = apiCall('https://api.spotify.com/v1/me/player/currently-playing', 'GET');
            ...
            if (msg[0] === "start") {
                ...
                apiCall('https://api.spotify.com/v1/me/player/play', 'PUT');
            }
            ...
            if (msg[0] === "pause" || msg[0] === "stop") {
                ...
                apiCall('https://api.spotify.com/v1/me/player/pause', 'PUT');
            }
