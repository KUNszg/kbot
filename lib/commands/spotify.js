        ...
        try {
            ...
            if (msg[0] === "volume" || msg[0] === "vol") {
                ...
                if (!msg[1]) {
                    ...
                    if (custom.strictChannels(channel)) {
                        kb.whisper(user['username'], `Volume on your spotify has been changed from ${playback.device.volume_percent}% to 50% (default).`);
                        return '';
                    }
                    return `${user['username']}, volume on your spotify has been changed from ${playback.device.volume_percent}% to 50% (default).`;
                }
