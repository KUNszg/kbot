        ...
        try {
            ...
            */
            ...
            if (msg[0] === "search") {
                ...
                const search = await apiCall(encodeURI(`https://api.spotify.com/v1/search?type=${type}&q=${query}&limit=1&offset=0`), user.username, "GET");
                ...
                if (type === "track") {
                    ...
                    const [track, artist, album] = new ModifyOutput([
                    ...
                    try {
                        ...
                        - you can play it on your spotify by doing kb yoink ${trackId}`;
                    } catch (err) {
                        if (err.error?.code === 403) {
                ...
                if (type === "artist") {
                    ...
                    const [artist] = new ModifyOutput([search.artists.items[0].name]).trimmer();
            ...
            if (msg[0] === "yoink") {
                ...
                if (checkCache) {
                    try {
                        ...
                        const [playing, artist] = new ModifyOutput([checkCache.track, checkCache.artist]).trimmer();
