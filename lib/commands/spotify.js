            ...
            if (msg[0] === "top") {
                ...
                if (findUser) {
                    ...
                    if (msg.find(i => i.toLowerCase() === "artists") || msg.find(i => i.toLowerCase() === "artist")) {
                        ...
                        (1) ${artist1}, (2) ${artist2}, (3) ${artist3}, (4) ${artist4}, (5) ${artist5}`.replace(/undefined/g, "no data");
                    }
                    ...
                    (1) ${song1} by ${artist1}, (2) ${song2} by ${artist2}, (3) ${song3} by ${artist3}`.replace(/undefined/g, "no data");
