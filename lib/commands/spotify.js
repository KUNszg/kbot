            ...
            */
            ...
            if (msg[0] === "yoink") {
                ...
                try {
                    ...
                    let checkIfStartedPlaying = await apiCall('https://api.spotify.com/v1/me/player/currently-playing', user['username'], 'GET');;

                    for (let i = 0; checkIfStartedPlaying.item.uri != yoinkedSong.item.uri; i++) {
                        await apiCall('https://api.spotify.com/v1/me/player/next', user['username'], 'POST');

                        checkIfStartedPlaying = await apiCall('https://api.spotify.com/v1/me/player/currently-playing', user['username'], 'GET');
                    }
