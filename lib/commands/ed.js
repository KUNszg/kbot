        ...
        try {
            ...
            switch (msg[0]) {
                ...
                case 'force':
                    ...
                    sleep(1000)
                    const edApi = await got(`https://huwobot.com/api/user?id=${user['user-id']}`).json();
                    ...
                    kb.whisper(user['username'], `I will remind you to enter dungeon in  ${utils.format(edApi.next_entry.toFixed(0) - (Date.now(new Date())/1000))} (forced reminder)`);
                    break;
