    ...
    invocation: async (channel, user, message, platform) => {
        try {
            ...
            if ((channel === "#haxk" || channel === "#pajlada") || channel === "#kunszg") {
                ...
                EU ${token.eu.current_price}g (change by ${token.eu.last_change}g, updated ${custom.humanizeDuration(howLongAgoEU)} ago),
                NA ${token.us.current_price}g (change by ${token.us.last_change}g, updated ${custom.humanizeDuration(howLongAgoNA)} ago)`;
            }
