...
module.exports = {
	...
	| [input] - provide a custom message | @[user] - searches for given user -- cooldown 45s`,
	permission: 0,
	cooldown: 45000,
	invocation: async (channel, user, message, args) => {
		try {
			...
			if (channel === "#forsen" &&  (msg[0] != "-channel" && ((msg[0] != "-bruh" && msg.length != 0) && (!msgCd.has(user['user-id']))))) {
