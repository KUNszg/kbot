...
module.exports = {
	...
	name: prefix + 'stats',
	aliases: null,
	description: `syntax: https://pastebin.com/BSKgp3jQ`,
    description_formatted: 'syntax: pastebin (dot) com/BSKgp3jQ',
	permission: 0,
	cooldown: 60000,
		...
		try {
            ...
            const statsColor = async() => {
                if (!msg[1]) {
                    ...
                    return `${user['username']}, you share your color (${user['color']}) with ${usersData[0].users-1}
                ...
                return `${user['username']}, this user's color (${checkIfUserExists[0].color}) is being used by
