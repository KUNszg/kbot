...
module.exports = {
    name: prefix + 'cookie',
    aliases: null,
    description: `ThePositiveBot's cookie reminders, (NOTE: this command is not a minigame, it's just a REMINDER for ThePositiveBot's cookies) see usage on my website: https://kunszg.xyz/commands#cookie_opt -- cooldown 8s`,
    description_formatted: `ThePositiveBot's cookie reminders, (NOTE: this is not a minigame, it's just a REMINDER for ThePositiveBot's cookies), see usage on my website: kunszg (dot) xyz/commands#cookie_opt -- cooldown 8s`,
    permission: 0,
    cooldown: 8000,
