...
module.exports = {
    name: prefix + 'cookie',
    aliases: null,
    description: `actions related to cookie reminders, usage: https://kunszg.xyz/commands#cookie_opt -- cooldown 8s`,
    description_formatted: `actions related to cookie reminders, usage: https://kunszg (dot) xyz/commands#cookie_opt -- cooldown 8s`,
    permission: 0,
    cooldown: 8000,
