    ...
    try {
      ...
      switch (msg[0]) {
        ...
        case 'whisper':
          ...
          if (userData[0].user_alias === getAlias[0].ID && userData[0].initplatform === 'channel') {
            await utils.query(
              `
                            UPDATE cookie_reminders
          ...
          if (userData[0].user_alias === getAlias[0].ID && userData[0].initplatform === 'whisper') {
            await utils.query(
              `
                            UPDATE cookie_reminders
          ...
          if (userData[0].user_alias === getAlias[0].ID && userData[0].initplatform === 'silence') {
            await utils.query(
              `
                            UPDATE cookie_reminders
                            SET initplatform="channel"
