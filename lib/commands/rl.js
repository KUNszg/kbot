		...
		try {
			...
			if (!msg[0]) {
                ...
                if (channel === "#forsen") {
                    ...
                    `(${custom.secondsToDhm(timeDifference)} ago) ${modifyOutput(93)}` :
                    `(${custom.format(timeDifference)} ago) ${modifyOutput(93)}`;
                }
			...
			if (typeof msg[0] !== 'undefined' && msg[0] != '') {
				...
				if (typeof getChannel != 'undefined') {
                    ...
                    if (channel === "#forsen") {
                        return (timeDifference>172800) ?
                        `${getChannel} (${custom.secondsToDhm(timeDifference)} ago) ${modifyOutput(93)}` :
                        `${getChannel} (${custom.format(timeDifference)} ago) ${modifyOutput(93)}`;
                    }
