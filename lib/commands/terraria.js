...
module.exports = {
    ...
    aliases: null,
    description: `commands fetching data from my Terraria server. Whisper/ping KUNszg for server IP. -- cooldown 4s`,
    permission: 0,
    cooldown: 4000,
        ...
        try {
            ...
            switch (msg[0]) {
                ...
                case 'broadcast':
                    ...
                    const broadcast = await endpoint('/v2/server/broadcast?msg=' + msg.join(' '));
                ...
                case 'reload':
                    ...
                    return `${user['username']}, ${reload.response.join(' ')}`;
                ...
                case 'list':
                    ...
                    kb.whisper(user['username'], 'list of online users: ' + playing.players.map(i=>i.nickname + ' (active: ' + i.active + ')')).split(',').join(', ');
