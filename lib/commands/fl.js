...
module.exports = {
    ...
    invocation: async (channel, user, message, platform) => {
        try {
            ...
            const checkChannel = await custom.query("SHOW TABLES LIKE ?", [channel.replace('#', '')])
            ...
            if (typeof userSpecifiedChannel != "undefined") {
                ...
                const checkIfLogging = await custom.query("SHOW TABLES LIKE ?", [userSpecifiedChannel.replace('#', '')]);
