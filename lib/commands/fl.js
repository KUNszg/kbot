...
module.exports = {
    ...
    no input will return a first line of the executing user`,
    permission: 0,
    cooldown: 4000,
    invocation: async (channel, user, message, args) => {
        try {
            ...
            if (!msg[0]) {
                ...
                if (await custom.banphrasePass(firstline[0].message, channel.replace('#', '')).banned === true) {
                ...
                if (channel === "#nymn" || channel === "#forsen") {
                    ...
                    return `${user['username']}, Your first line in this channel was:
                    (${custom.format(timeDifferenceRaw/1000)} ${modifyOutput(130)}`;
                }
