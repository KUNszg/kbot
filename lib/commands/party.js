			...
			switch (msg[0]) {
				...
				case "ping":
					...
					if (usersInPartyPing.length > 10) {
						return `${user['username']}, I cannot bing more than 10 people monkaS you can do it yourself by getting a list of users with "kb party list"`;
					}
					return `${partyDataPing[0].username} is binging you all, it is time FeelsDankMan 🔔 | ${usersInPartyPing.map(i => i.username).join(', ')}`;
