...
(async () => {
  ...
  async function handler(channel, user, message, self, event, messageState) {
    ...
    //       kb.action(
    //         channel,
    //         // todo: move to UtilityRepository usage
    //         utils.randomElement(['KKurwa 🚨 NAURA', 'Clue TeaTime 🚨 TMI MELTDOWN'])
    //       );
    //       return;
    //     }
    //
    ...
    // todo: add global channel cooldown for commands for strict channels
    // todo: add cooldown reduction for bot owner/elevated users
    //
...
*/
    ...
    // todo: implement in blocking commands, currently under `Commons.UtilityRepository().isBlockingCommandProcessing()`
    //stall.clear();
    ...
    //   todo: deprecated - remove strict column from channels table
    ...
    // todo: remove mention_bans table
  ...
  // todo: method that auto leaves channel
  if (msgid === 'msg_banned') {
